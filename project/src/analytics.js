...
export default function Tickets() {
  ...
  const data = [
    ...
    return (
      ...
      <h2 style={{paddingLeft:411}}> The Following charts will help you better understand the system </h2>
      <div style={{display:'flex', flexDirection:'row', paddingLeft:110}}>
        ...
        <h1> SCATTER PLOT </h1>
          ...
          <h1 style={{marginLeft:155}}> WORD CLOUD </h1>
